...
const CommunityPostDetail: NextPage = () => {
  return (
    <Layout canGoBack>
      <div>
        <span className="my-2.5 ml-4 inline-flex items-center rounded-full bg-gray-100 px-2.5 py-0.5 text-xs text-gray-800">
          동네질문
        </span>
        ...
        <div>
          ...
          <div className="mt-3 flex w-full space-x-5 border-t border-b-[2px] py-2.5 pl-4 text-gray-700">
