      ...
      {kind === "phone" ? (
        <div className="flex rounded-md shadow-sm">
          ...
          <input
            id={name}
            {...rest}
            className="focus:outlin-none w-full appearance-none rounded-md rounded-l-none border border-gray-300
            px-3 py-2 placeholder-gray-400 shadow-sm  focus:border-orange-500 focus:ring-orange-500"
          />
        </div>
      ) : null}
    </div>
