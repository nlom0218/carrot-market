      ...
      <div className="mt-8">
        ...
        <form className="mt-8 flex flex-col">
          <label htmlFor="input" className=" text-sm font-medium text-gray-700">
            {method === "email" ? "Email adderss" : null}
          ...
          <div className="mt-1">
            ...
            {method === "phone" ? (
              <div className="flex rounded-sm shadow-md">
                <span className="flex select-none items-center justify-center rounded-l-md border border-r-0 border-gray-400 bg-gray-50 px-3 text-sm text-gray-500">
                  +82
                </span>
                <input
                  id="input"
          ...
          <button className=" mt-6 rounded-md border border-transparent bg-orange-500 py-2 px-4 font-medium text-white shadow-sm hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
            {method === "email" ? "Get login link" : null}
            {method === "phone" ? "Get login link" : null}
          </button>
        </form>
        <div className="mt-8">
