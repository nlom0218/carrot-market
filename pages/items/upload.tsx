...
const Upload: NextPage = () => {
  return (
    <div className="px-4 py-16">
      ...
      <button className=" mt-4 w-full rounded-md border border-transparent bg-orange-500 py-2 px-4 font-medium text-white shadow-sm transition-colors hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
        Upload product
      </button>
    </div>
  );
